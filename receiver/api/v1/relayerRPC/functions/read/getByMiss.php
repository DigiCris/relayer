...
/*!
* \brief       Read all that matches miss in relayerRPC
* \details     Search in the database relayerRPC that matches miss and returns them in an array.
* \param       (INT) miss searching table by matching it.
...
*/
function getByMiss($miss) {
    $register = new relayerRPC();
    $success['response'] = $register->readMiss($miss);
