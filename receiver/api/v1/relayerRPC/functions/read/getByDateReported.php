...
/*!
* \brief       Read all that matches dateReported in relayerRPC
* \details     Search in the database relayerRPC that matches dateReported and returns them in an array.
* \param       (DATE) dateReported searching table by matching it.
...
*/
function getByDateReported($dateReported) {
    $register = new relayerRPC();
    $success['response'] = $register->readDateReported($dateReported);
