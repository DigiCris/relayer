...
/*!
* \brief       Read all that matches consecutiveMiss in relayerRPC
* \details     Search in the database relayerRPC that matches consecutiveMiss and returns them in an array.
* \param       (INT) consecutiveMiss searching table by matching it.
...
*/
function getByConsecutiveMiss($consecutiveMiss) {
    $register = new relayerRPC();
    $success['response'] = $register->readConsecutiveMiss($consecutiveMiss);
