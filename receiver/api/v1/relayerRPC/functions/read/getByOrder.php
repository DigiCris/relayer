...
/*!
* \brief       Read all that matches order in relayerRPC
* \details     Search in the database relayerRPC that matches order and returns them in an array.
* \param       (INT) order searching table by matching it.
