...
/*!
* \brief       Read all that matches request in requestLogs
* \details     Search in the database requestLogs that matches request and returns them in an array.
* \param       (VARCHAR) request searching table by matching it.
...
*/
function getByRequest($request) {
    $register = new requestLogs();
    $success['response'] = $register->readRequest($request);
