...
/*!
* \brief       Read all that matches txHash in requestLogs
* \details     Search in the database requestLogs that matches txHash and returns them in an array.
* \param       (VARCHAR) txHash searching table by matching it.
