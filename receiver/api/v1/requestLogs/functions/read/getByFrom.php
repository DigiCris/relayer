...
/*!
* \brief       Read all that matches from in requestLogs
* \details     Search in the database requestLogs that matches from and returns them in an array.
* \param       (VARCHAR) from searching table by matching it.
...
function getByFrom($from) {
    ...
    $success['response'] = $register->readFrom($from);
