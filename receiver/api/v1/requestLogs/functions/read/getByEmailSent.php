...
/*!
* \brief       Read all that matches emailSent in requestLogs
* \details     Search in the database requestLogs that matches emailSent and returns them in an array.
* \param       (INT) emailSent searching table by matching it.
...
*/
function getByEmailSent($emailSent) {
    $register = new requestLogs();
    $success['response'] = $register->readEmailSent($emailSent);
