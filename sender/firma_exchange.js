...
const calleeAddress = process.env.CONTRATO_RELAYER;
...
*/
async function main() {
    const data = await callee_contract.methods.setLink("0xB42e1655DF5770A86AD6e4A22c96D9Fe98282165").encodeABI(); // Esta es la función que debo modificar para llamar distintas funciones. El address es la de la persona a quien se le mintea los tokens
    //console.log(data);
