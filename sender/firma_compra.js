...
*/
async function main() {
    const data = await callee_contract.methods.comprar("CTUSD","SWF","100000000").encodeABI(); // Esta es la función que debo modificar para llamar distintas funciones. El address es la de la persona a quien se le mintea los tokens
    //console.log(data);
